...
{
   mRoot->loadPlugin("/usr/lib/x86_64-linux-gnu/OGRE-1.7.4/RenderSystem_GL");
...
//    mWindow = mRoot->createRenderWindow( name, 1440, 900, false, &params);
        ...
        mWindow = mRoot->createRenderWindow( name, 1440, 900, true);//, &params);
    mWindow = mRoot->initialise(true, "ibex");
