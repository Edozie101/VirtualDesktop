...
//                                +pow(((sin(pos.x/13.0+time+0.2)+1.0)/2.0),2.0)*0.0001
//                                ,//(cos(pos.x/17.0+time)+sin(pos.x/7.0+time*1.7)*0.5)*.0025,
//                           reflected.y,
//                           reflected.z+
//                                pow(((sin(pos.z/30.0+time)+1.0)/2.0),2.0)*0.001
//                                +pow(((sin(pos.z/17.0+time+0.1)+1.0)/2.0),2.0)*0.0001
//                                +pow(((sin(pos.z/13.0+time+0.2)+1.0)/2.0),2.0)*0.0001
//                           );
