...
#ifdef WIN32
	char *lpbitmap;
	GLuint createApplicationLauncherBitmap(std::vector<std::string> &directories, size_t &width, size_t &height, int &selectedX, int &selectedY,std::map<std::pair<int,int>,std::string> &applicationList);
